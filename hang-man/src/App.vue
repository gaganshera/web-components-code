...
window.onload = function () {
  ...
  // Get elements
  var showLives = document
    .querySelector("hang-man")
    .shadowRoot.getElementById("mylives");
  var showCatagory = document
    .querySelector("hang-man")
    .shadowRoot.getElementById("scatagory");
  var getHint = document
    .querySelector("hang-man")
    .shadowRoot.getElementById("hint");
  var showClue = document
    .querySelector("hang-man")
    .shadowRoot.getElementById("clue");
  let catagoryName = document
    .querySelector("hang-man")
    .shadowRoot.getElementById("catagoryName");

  // create alphabet ul
  var buttons = function () {
    let myButtons = document
      .querySelector("hang-man")
      .shadowRoot.getElementById("buttons");
  ...
  // Create geusses ul
  var result = function () {
    let wordHolder = document
      .querySelector("hang-man")
      .shadowRoot.getElementById("hold");
  ...
  // Hangman
  var canvas = function () {
    let myStickman = document
      .querySelector("hang-man")
      .shadowRoot.getElementById("stickman");
  ...
  document
    ...
    document
      .querySelector("hang-man")
      .shadowRoot.getElementById("my-word")
      .parentNode.removeChild(
        document.querySelector("hang-man").shadowRoot.getElementById("my-word")
      );
    document
      .querySelector("hang-man")
      .shadowRoot.getElementById("alphabet")
      .parentNode.removeChild(
        document.querySelector("hang-man").shadowRoot.getElementById("alphabet")
      );
    showClue.innerHTML = "";
    let myStickman = document
      .querySelector("hang-man")
